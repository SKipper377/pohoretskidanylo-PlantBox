...
<body id="top">
        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul class="nav-menu" id="navMenu">
                    <li><a href="index.html" class="nav-link" data-en="Home" data-pl="Strona Główna">Home</a></li>
                    <li><a href="forum.php" class="nav-link active" data-en="Forum" data-pl="Forum">Forum</a></li>
                    <li><a href="about.html" class="nav-link" data-en="About Us" data-pl="O Nas">About Us</a></li>
                    <li><a href="index.html#faq" class="nav-link" data-en="FAQ" data-pl="FAQ">FAQ</a></li>
                    <li><a href="info.html" class="nav-link" data-en="Plant Guide" data-pl="Przewodnik Roślin">Plant Guide</a></li>
                    <li><a
  ...
  <main id="main-content">
    ...
    <!-- ===== FORUM ===== -->
    <section class="forum-main" id="forum">
      <div class="container">
      ...
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <ul>
            ...
            <li><a href="#" data-en="Download" data-pl="Pobierz">Download</a></li>
          </ul>
        </div>
        <div class="footer-section">
          <h4 data-en="Community" data-pl="Społeczność">Community</h4>
          <ul>
            <li><a href="#forum" data-en="Forum" data-pl="Forum">Forum</a></li>
        ...
        <div class="footer-section">
          ...
          <ul>
            <li><a href="mailto:etiap22@gmail.com">etiap22@gmail.com</a></li>
          </ul>
        </div>
      </div>
